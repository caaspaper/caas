...
\author{Alexander Gessler, Simon Hanna, Ashley Marie Smith\\Universität Stuttgart, Institute for Parallel and Distributed Systems \\ \{gessleah, hannasn, smithae\} @studi.informatik.uni-stuttgart.de}
...
A.~Mondal, K.~Goda, and M.~Kitsuregawa. ``Effective Load-balancing via Migration and Replication in Spatial Grids." \emph{Database and Expert Systems Applications: Lecture Notes in Computer Science, Vol. 2736}, Springer, 2003: pp.202-211. \\

\bibitem{p2p:godfrey}
B.~Godfrey, K.~Lakshminarayanan, S.~Surana, and R.~Karp. ``Load Balancing in Dynamic Structured P2P Systems." in \emph{Proc. of 23. INFOCOM}, Hong Kong, China: IEEE Computer Society, 2004. \\

\bibitem{grids:scholl}
T.~Scholl, B.~Bauer, et al. ``Workload-Aware Data Partitioning in Community-Driven Data Grids." in \emph{EDBT} 2009, St. Petersburg, Russia: ACM.\\

\bibitem{MultiLevel:Lueb2}
C.~L\"{u}bbe, and B.~Mitschang, ``Holistic load-balancing in a distributed spatial cache." in \emph{Proc. of 24th Int. Conf. on Mobile Data Management}, Milan, Italy: IEEE Computer Society, 2013: pp. 267-270.\\

\bibitem{disco:Luebbe}
C.~L\"{u}bbe et.al. ``DiSCO: A Distributed Semantic Cache Overlay for Location-Based Services." \emph{Proc. of 15th Int. Conf. on Mobile Data Management}, Lulea, Sweden: EEE Computer Society, 2011: pp. 1-10.\\

\bibitem{client:wee}
S.~Wee and H.~Liu. ``Client-side load balancer using cloud." \emph{Proc. of 25th Symp. on Applied Computing (SAC'10)}, Sierre, Switzerland: IEEE Computer Society, 2010, pp. 399-405.\\

\bibitem{lb:rand}
M.~Randles, D.~Lamb, and A.~Taleb-Bendiab. ``A Comparative study into distributed load balancing algorithms for cloud computing." \emph{Proc. of 24th Int. Conf on Advanced Information Networking and Applications Workshop}, Perth, WA: IEEE Computer Society, 2010, pp. 551-556.\\

\bibitem{Delaunay:Bose}
P.~Bose and P.~Morin. ``Online routing in triangulations." in \emph{Proc. of 10 th Annual Int. Symp. on Algorithms and Computation (ISAAC'99)}, Berlin: Springer-Verlag, pp.113-122. \\

\bibitem{DistrDelaunay:Lee}
D.~Y.~Lee, S.~.S.~Lam. ``Efficient and accurate protocols for distributed Delaunay triangulation under Churn." \emph{Proc. of 16th Int. Conf. on Network Protocols}, Orlando, FL: IEEE Computer Society, 2008, pp. 124-136. \\
