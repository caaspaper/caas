...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[width=.7\textwidth]{arch2-cropped}
...
\section{Results and Discussion}
  ...
  \begin{figure}[htb]
    \begin{center}
		\includegraphics[width=.5\textwidth]{results15}
	...
	\end{figure}
	 ...
	 \begin{figure}[htb]
    \begin{center}
			\includegraphics[width=.5\textwidth]{results20}
...
the system with scaling-out is able to scale almost linearly. 
...
to 2nd or 3rd neighbors in order to achieve $\mathcal O (\log n)$ routing, as well keep as local routing shortlists. 
