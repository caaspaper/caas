...
\section{Results and Discussion}
  ...
  \begin{figure}[htb]
    \begin{center}
      \includegraphics[trim = 2.0cm 0.5cm 2.0cm 1.0cm, clip=true,  width=.8\textwidth]{3d_k15}
	...
	\end{figure}
	 ...
	 \begin{figure}[htb]
    \begin{center}
      \includegraphics[trim = 2.0cm 0.5cm 2.0cm 1.0cm, clip=true,  width=.8\textwidth]{3d_k20}
